        ...
        <div class="tarjeta-negocio">
            ...
            <form id="formularioNegocio" class="formulario-negocio">
                ...
                <div class="contenedor-botones">
                    <!-- <button type="button" class="nav-btn" id="btnMenu" onclick="transicionPagina('EGM-002.php')">
                        <img src="../Imagenes/menu-icon.png" alt="Volver">
                        Menu Principal
                    </button> -->
                    <button type="submit" class="nav-btn" id="btnCrear" onclick="transicionPagina('EGM-002.php')">
